...
// ==========================================
const actionForm = document.getElementById('action-form');      // core elements - look to understand - what is a dom tree
...
const updateCounter = () => {
    ...
    total++;
    cardCounter.textContent = "Total tasks: ${total}";
};
...
actionList.addEventListener('click', (e) => {
    ...
    if (action === 'toggle') {
        ...
        currentCard.classList.toggle()// falta code
    } 
